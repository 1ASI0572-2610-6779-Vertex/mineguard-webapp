...
export class RegisterCompanyPage {
  ...
  readonly plans: readonly PlanOption[] = [
    { key: 'STARTER', nameKey: 'iam.registerCompany.plans.starter.name', descKey: 'iam.registerCompany.plans.starter.desc', price: '$250' },
    { key: 'STANDARD', nameKey: 'iam.registerCompany.plans.standard.name', descKey: 'iam.registerCompany.plans.standard.desc', price: '$499' },
    { key: 'ENTERPRISE', nameKey: 'iam.registerCompany.plans.enterprise.name', descKey: 'iam.registerCompany.plans.enterprise.desc', price: '$899' },
  ];
