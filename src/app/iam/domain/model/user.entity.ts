 ...
 * });
 *
 * console.log(user.username); // 'admin_mineguard'
 * user.username = 'admin.new'; // Can be updated
 * ```
 */
export class User implements BaseEntity {
   ...
   * This is typically a corporate ID or user handle used for authentication.
   * @defaultValue ''
   */
   ...
   * @param props.username - The unique username/corporate ID for the account
   *
   * @remarks
   ...
   *
   * @remarks
   * User accounts may update their username as part of account management.
